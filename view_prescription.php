...
<html>
<head>
<title><?php $user?> festus Agrovet Management System</title>
...
<div id="button">
		<ul>
			...
			<li><a href="view_prescription.php">View Uses</a></li>
...
<hr/>	
    <div class="tabbed_area">  
        ...
        <ul class="tabs">  
            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">Uses </a></li>  
       ...
       $result = mysql_query("SELECT * FROM prescription")or die(mysql_error());
        ...
        echo "<tr> <th>Customer</th><th>Uses N<sup>o</sup></th> <th>Invoice N<sup>o</sup></th><th>Date </th></tr>";
